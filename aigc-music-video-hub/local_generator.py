...
if __name__ == "__main__":
    ...
    # Prompt matching Style 2: Guardian Mountain Epic Tech Style (史詩電音風)
    prompt_text = "epic synth-pop, high-tech electronic beats, futuristic cyberpunk atmosphere, cinematic driving bass, majestic, 128 BPM"
