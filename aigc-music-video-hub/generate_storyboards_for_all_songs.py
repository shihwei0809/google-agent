...
master_scenes = [   {   'id': 1,
    ...
    {   'id': 22,
        ...
        'name': '綠色循環標章'},
    {   'id': 23,
        'image': 'Automated bottling line, shiny metallic containers filled with high-purity solvent on a fast-moving conveyor belt, glowing lasers inspect caps, futuristic cleanroom refinery, highly detailed, photorealistic, 8k.',
        'motion': 'Metallic bottles moving along the conveyor belt rapidly, robotic arms operating, glowing laser beam flashing, smooth mechanical motion.',
        'name': '自動灌裝生產線'},
    {   'id': 24,
    ...
    {   'id': 51,
        ...
        'name': '吊掛isotank'},
    {   'id': 52,
        'image': 'An automated guided vehicle (AGV) transporting chemical drums through a high-tech warehouse aisle, glowing sensors, futuristic green energy refinery, highly detailed, photorealistic, 8k.',
        'motion': 'Slow panning of the robotic vehicle moving along the warehouse floor smoothly.',
        'name': '無人搬運車'},
    {   'id': 53,
        'image': 'Giant industrial cooling towers with swirling water vapor under a beautiful sunset sky, eco-friendly water recycling system, futuristic green energy refinery, highly detailed, photorealistic, 8k.',
        'motion': 'Water vapor gently rising from the cooling towers, sunset sky shifting colors slowly.',
        'name': '冷卻塔與循環水'},
    {   'id': 54,
        'image': 'Advanced multi-stage water purification system for electronic grade ultra-pure water, sparkling clear water inside glass chambers, futuristic cleanroom aesthetic, highly detailed, photorealistic, 8k.',
        'motion': 'Purified water swirling gently inside the glass chamber, soft backlighting.',
        'name': '超純水純化'},
    {   'id': 55,
        'image': 'A sleek electric semi-truck transporting chemical containers driving on a highway lined with wind turbines during sunrise, green logistics, clean environment, highly detailed, photorealistic, 8k.',
        'motion': 'Smooth highway panning shot, wheels spinning, wind turbines rotating in the background.',
        'name': '低碳綠色供應鏈'},
    {   'id': 56,
        'image': 'Spherical cryogenic chemical storage tanks covered in light frost, glowing blue thermal monitoring lines, futuristic green energy refinery, highly detailed, photorealistic, 8k.',
        'motion': 'Slow panning shot showing the frost-covered storage tanks with subtle thermal indicator glow.',
        'name': '超低溫化學儲存'},
    {   'id': 57,
        'image': 'A material scientist analyzing microscopic nanostructures on a high-tech electron microscope screen, glowing UI, dark advanced research lab, highly detailed, photorealistic, 8k.',
        'motion': 'UI interface loading scanning data, scientist adjusting focus, high precision.',
        'name': '電子顯微鏡分析'},
    {   'id': 58,
        'image': 'A refinery technician wearing a futuristic smart cleanroom suit with integrated HUD visor displaying diagnostic stats, neon blue accents, futuristic cleanroom aesthetic, highly detailed, photorealistic, 8k.',
        'motion': 'Close up of the visor glowing with telemetry stats, technician looking around slowly.',
        'name': '智慧防護與安全'},
    {   'id': 59,
        'image': 'A modern industrial rainwater harvesting facility with lush vertical gardens on the walls, rain droplets glistening on leaves, clean eco tech, highly detailed, photorealistic, 8k.',
        'motion': 'Camera panning down the vertical green garden, water droplets trickling down leaves.',
        'name': '雨水回收綠化'},
    {   'id': 60,
        'image': 'Futuristic carbon capture facility with massive air intake fans sucking in air, transforming carbon into green energy canisters, glowing green indicators, sustainable ESG tech, highly detailed, photorealistic, 8k.',
        'motion': 'Intake fans rotating steadily, green indicator lights pulsing on the energy canisters.',
        'name': '碳捕集與利用'}]
