...
master_scenes = [   {   'id': 1,
    ...
    {   'id': 53,
        ...
        'name': '超純水純化'},
    {   'id': 54,
        'image': 'A smart safety monitoring system screen with neon green gas sensor indicators overlaid on chemical pipelines, futuristic green energy refinery, highly detailed, photorealistic, 8k.',
        'motion': 'Indicator lights pulsing slowly on the screen, real-time safety telemetry scrolling.',
        'name': '氣體偵測安全'},
    {   'id': 55,
