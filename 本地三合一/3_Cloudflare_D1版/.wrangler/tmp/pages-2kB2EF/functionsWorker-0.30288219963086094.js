...
async function onRequestPost(context) {
  ...
  try {
    ...
    `).bind(
      body.formObject.materialNo || "",
      body.formObject.tankNo || "",
      body.formObject.batchNo || "",
      body.formObject.supplier || "",
      body.formObject.deliveryPlace || "",
      body.targetPlace || "",
      body.formObject.rawQr || "",
      body.status || "\u6838\u5C0D\u6210\u529F",
      body.photoBatchUrl || "",
      body.photoLocUrl || "",
      body.sourceOrder || "",
...
// ../.wrangler/tmp/pages-2kB2EF/functionsRoutes-0.49189939126182214.mjs
var routes = [
  {
    routePath: "/api/save",
    mountPath: "/api",
