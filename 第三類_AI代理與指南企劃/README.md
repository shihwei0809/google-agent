# 🤖 第三類：AI 代理與指南企劃 (AI Agents, Guides & Project Specs)
...
| 🎓 [Google Classroom anget](./Google%20Classroom%20anget/) | Google Classroom 課程作業自動發布、批改與學生通知自動化代理 | Python, Google Classroom API, GAS |
| 🧴 [保養品](./保養品/) | 保養品智能客服問答與個性化商品推薦 AI 機器人 | HTML, JS, Gemini API, Groq API |
| ✈️ [grad-trip](./grad-trip/) | 畢業旅行專屬 PPT 簡報自動生成器與旅遊行程規劃工具 | Python, python-pptx, Reveal.js |
| 📌 [padlet-board](./padlet-board/) | 互動式類 Padlet 便籤討論板與主題展示看板系統 | HTML5, CSS3, Firebase Realtime DB |
