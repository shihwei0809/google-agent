...
ps_script = """# 自動開工 Git 同步與多電腦備份自動合併腳本 (多電腦完全整合版)
...
with open(r"C:\GOOGLE ANGET\AutoStartWork.ps1", "w", encoding="utf-8-sig") as f:
    f.write(ps_script)

print("Updated C:\\GOOGLE ANGET\\AutoStartWork.ps1 for multi-computer auto-merge successfully!")
