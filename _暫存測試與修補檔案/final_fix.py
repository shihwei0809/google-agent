...
# Apply flawless patch again, but fix the clear_pattern issue
...
# 4. clear
content = content.replace('                if "po_var" in entry: entry["po_var"].set("")', '                if "po_var" in entry: entry["po_var"].set("")\n                if "origin_var" in entry: entry["origin_var"].set("")\n                if "part_var" in entry: entry["part_var"].set("")')
content = content.replace('            if "po_var" in entry: entry["po_var"].set("")', '            if "po_var" in entry: entry["po_var"].set("")\n            if "origin_var" in entry: entry["origin_var"].set("")\n            if "part_var" in entry: entry["part_var"].set("")')
