...
async function onRequestPost(context) {
  ...
  try {
    ...
    await env.DB.prepare("INSERT INTO ArchiveStore (id, timestamp, dataJSON) VALUES (?1, ?2, ?3)").bind(String(archiveName), timestamp, dataJSON).run();
...
async function onRequestPost2(context) {
  ...
  try {
    ...
    for (const key of Object.keys(payload)) {
      ...
      stmts.push(
        env.DB.prepare("INSERT INTO DataStore (key, value) VALUES (?1, ?2) ON CONFLICT(key) DO UPDATE SET value = ?2").bind(key, String(value))
      );
    }
    if (stmts.length > 0) {
...
// ../.wrangler/tmp/pages-fpMISQ/functionsRoutes-0.05271531302946808.mjs
var routes = [
  {
...
// C:/Users/C606-PC/AppData/Roaming/npm/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/C606-PC/AppData/Roaming/npm/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
